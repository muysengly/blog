    ...
    !function(e, t, r, a, o) {
      ...
      function I(e2, t2) {
        return new Promise((r2, a2) => {
          let o2 = new Image();
          o2.crossOrigin = "Anonymous", o2.onload = function() {
            if (t2 && 1 !== t2) {
...
${e3.text}` : "").filter((e3) => e3.trim()).join("\n\n");
      ...
      r.default = class {
        constructor(e2) {
          (0, i.default)(e2), (0, s.default)(e2), (0, c.default)(e2), (0, u.default)(e2), (0, f.default)(e2), (0, m.default)(e2), (0, v.default)(e2), (0, b.default)(e2), (0, w.default)(e2), (0, k.default)(e2), (0, S.default)(e2), (0, T.default)(e2), (0, E.default)(e2), (0, F.default)(e2), (0, z.default)(e2), (0, A.default)(e2), (0, O.default)(e2), (0, L.default)(e2), (0, V.default)(e2), (0, _.default)(e2), (0, B.default)(e2), (0, U.default)(e2), (0, Z.default)(e2), (0, G.default)(e2), (0, J.default)(e2), (0, et.default)(e2), (0, ea.default)(e2), (0, ei.default)(e2), (0, es.default)(e2), (0, ec.default)(e2), (0, eu.default)(e2), (0, ef.default)(e2), (0, em.default)(e2), (0, eb.default)(e2), (0, ev.default)(e2);
        }
      };
      ...
      function s(e2) {
        let { i18n: t2, notice: r2, template: { $video: a2, $player: o2 } } = e2, s2 = (e3) => {
          (0, i.default).on("change", () => {
            e3.emit("fullscreen", i.default.isFullscreen);
          }), (0, i.default).on("error", (t3) => {
            e3.emit("fullscreenError", t3);
          }), (0, n.def)(e3, "fullscreen", { get: () => i.default.isFullscreen, async set(t3) {
            t3 ? (e3.state = "fullscreen", await (0, i.default).request(o2), (0, n.addClass)(o2, "art-fullscreen")) : (await (0, i.default).exit(), (0, n.removeClass)(o2, "art-fullscreen")), e3.emit("resize");
          } });
        }, l = (e3) => {
      ...
      var a = e("@parcel/transformer-js/src/esmodule-helpers.js");
      function o(e2) {
        return { ...e2, html: '<a href="https://artplayer.org" target="_blank">ArtPlayer 5.2.1</a>' };
      }
      a.defineInteropFlag(r), a.export(r, "default", () => o);
      ...
      var a = e("@parcel/transformer-js/src/esmodule-helpers.js");
      a.defineInteropFlag(r);
      var o = e("../utils"), i = e("bundle-text:./loading.svg"), n = a.interopDefault(i), s = e("bundle-text:./state.svg"), l = a.interopDefault(s), c = e("bundle-text:./check.svg"), p = a.interopDefault(c), u = e("bundle-text:./play.svg"), d = a.interopDefault(u), f = e("bundle-text:./pause.svg"), h = a.interopDefault(f), m = e("bundle-text:./volume.svg"), g = a.interopDefault(m), v = e("bundle-text:./volume-close.svg"), y = a.interopDefault(v), b = e("bundle-text:./screenshot.svg"), x = a.interopDefault(b), w = e("bundle-text:./setting.svg"), j = a.interopDefault(w), k = e("bundle-text:./arrow-left.svg"), C = a.interopDefault(k), S = e("bundle-text:./arrow-right.svg"), I = a.interopDefault(S), T = e("bundle-text:./playback-rate.svg"), $ = a.interopDefault(T), E = e("bundle-text:./aspect-ratio.svg"), M = a.interopDefault(E), F = e("bundle-text:./config.svg"), H = a.interopDefault(F), z = e("bundle-text:./pip.svg"), D = a.interopDefault(z), A = e("bundle-text:./lock.svg"), R = a.interopDefault(A), O = e("bundle-text:./unlock.svg"), Y = a.interopDefault(O), L = e("bundle-text:./fullscreen-off.svg"), P = a.interopDefault(L), V = e("bundle-text:./fullscreen-on.svg"), q = a.interopDefault(V), _ = e("bundle-text:./fullscreen-web-off.svg"), N = a.interopDefault(_), B = e("bundle-text:./fullscreen-web-on.svg"), W = a.interopDefault(B), U = e("bundle-text:./switch-on.svg"), K = a.interopDefault(U), Z = e("bundle-text:./switch-off.svg"), X = a.interopDefault(Z), G = e("bundle-text:./flip.svg"), Q = a.interopDefault(G), J = e("bundle-text:./error.svg"), ee = a.interopDefault(J), et = e("bundle-text:./close.svg"), er = a.interopDefault(et), ea = e("bundle-text:./airplay.svg"), eo = a.interopDefault(ea);
      r.default = class {
        constructor(e2) {
          let t2 = { loading: n.default, state: l.default, play: d.default, pause: h.default, check: p.default, volume: g.default, volumeClose: y.default, screenshot: x.default, setting: j.default, pip: D.default, arrowLeft: C.default, arrowRight: I.default, playbackRate: $.default, aspectRatio: M.default, config: H.default, lock: R.default, flip: Q.default, unlock: Y.default, fullscreenOff: P.default, fullscreenOn: q.default, fullscreenWebOff: N.default, fullscreenWebOn: W.default, switchOn: K.default, switchOff: X.default, error: ee.default, close: er.default, airplay: eo.default, ...e2.option.icons };
      ...
      class m extends f.default {
        ...
        resize() {
          ...
          if (e2.setting && this.show) {
            ...
            (0, h.setStyle)(o2, "height", `${u2}px`), (0, h.setStyle)(o2, "width", `${i2}px`), p2 + i2 > c2 ? ((0, h.setStyle)(o2, "left", null), (0, h.setStyle)(o2, "right", null)) : ((0, h.setStyle)(o2, "left", `${p2}px`), (0, h.setStyle)(o2, "right", "auto"));
          }
        }
        inactivate(e2) {
