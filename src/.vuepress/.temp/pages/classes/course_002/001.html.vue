<template><div><p><strong>Python</strong> is a general-purpose interpreted, interactive, object-oriented, and high-level programming language. It was created by Guido van Rossum during 1985- 1990. Like Perl, Python source code is also available under the GNU General Public License (GPL). This <strong>tutorial</strong> gives enough understanding on <strong>Python programming</strong> language.</p>
<h2 id="why-to-learn-python" tabindex="-1"><a class="header-anchor" href="#why-to-learn-python"><span>Why to Learn Python?</span></a></h2>
<p><strong>Python</strong> is a high-level, interpreted, interactive and object-oriented scripting language. Python is designed to be highly readable. It uses English keywords frequently where as other languages use punctuation, and it has fewer syntactical constructions than other languages.</p>
<p><strong>Python</strong> is a MUST for students and working professionals to become a great Software Engineer specially when they are working in Web Development Domain. I will list down some of the key advantages of learning Python:</p>
<ul>
...
<h2 id="characteristics-of-python" tabindex="-1"><a class="header-anchor" href="#characteristics-of-python"><span>Characteristics of Python</span></a></h2>
<p>Following are important characteristics of <strong>Python Programming</strong> −</p>
<ul>
...
<h2 id="hello-world-using-python" tabindex="-1"><a class="header-anchor" href="#hello-world-using-python"><span>Hello World using Python.</span></a></h2>
<p>Just to give you a little excitement about Python, I'm going to give you a small conventional Python Hello World program, You can try it using Demo link.</p>
<div class="language-python line-numbers-mode" data-highlighter="shiki" data-ext="python" data-title="python" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre v-pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#0184BC;--shiki-dark:#56B6C2">print</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">(</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379">"Hello, Python!"</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF">)</span><span style="--shiki-light:#000000;--shiki-dark:#FFFFFF">;</span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div></div></div><h2 id="applications-of-python" tabindex="-1"><a class="header-anchor" href="#applications-of-python"><span>Applications of Python</span></a></h2>
<p>As mentioned before, Python is one of the most widely used language over the web. I'm going to list few of them here:</p>
<ul>
...
<h2 id="audience" tabindex="-1"><a class="header-anchor" href="#audience"><span>Audience</span></a></h2>
<p>This <strong>Python tutorial</strong> is designed for software programmers who need to learn Python programming language from scratch.</p>
