const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/vidstack-H72EDyqs-Cj445G1A.js","assets/app-DmgqUeCd.js"])))=>i.map(i=>d[i]);
var vs=Object.defineProperty;var fs=Object.getPrototypeOf;var hs=Reflect.get;var me=e=>{throw TypeError(e)};var $s=(e,t,s)=>t in e?vs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var P=(e,t,s)=>$s(e,typeof t!="symbol"?t+"":t,s),Gt=(e,t,s)=>t.has(e)||me("Cannot "+s);var v=(e,t,s)=>(Gt(e,t,"read from private field"),s?s.call(e):t.get(e)),b=(e,t,s)=>t.has(e)?me("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),D=(e,t,s,n)=>(Gt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),h=(e,t,s)=>(Gt(e,t,"access private method"),s);var Lt=(e,t,s)=>hs(fs(e),s,t);import{aM as x,o as at,aO as ge,bo as bs,h as R,ar as C,j as ye,k as _,aL as gs,ap as ys,aP as xs,y as w,bp as xe,G as Ss,aZ as Se,at as st,bq as g,r as ot,_ as Ts,b0 as ws,br as Te,az as ks,bs as Cs,C as As,aR as we,bt,q as Yt,bu as Ds,bv as ke,bw as Ms,a as Is,ah as Os,B as V,bx as Ps,aW as _s,au as Ce,l as Nt,a$ as Gs,by as Ls,bz as Ns,bA as Bs,bn as Ae}from"./app-DmgqUeCd.js";import{A as E,T as Fs,D as ve,x as l,s as Vs,$ as Rs,L as De}from"./vidstack-CwTj4H1w-Bp4ARBvF.js";/**
 * @license
 ...
 */const nt=(e,t)=>{var s,n;const i=e._$AN;if(i===void 0)return!1;for(const o of i)(n=(s=o)._$AO)===null||n===void 0||n.call(s,t,!1),nt(o,t);return!0},yt=e=>{let t,s;do{if((t=e._$AM)===void 0)break;s=t._$AN,s.delete(e),e=t}while((s==null?void 0:s.size)===0)},Me=e=>{for(let t;t=e._$AM;e=t){let s=t._$AN;if(s===void 0)t._$AN=s=new Set;else if(s.has(e))break;s.add(e),Us(t)}};function zs(e){this._$AN!==void 0?(yt(this),this._$AM=e,Me(this)):this._$AM=e}function Hs(e,t=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(t)if(Array.isArray(n))for(let o=s;o<n.length;o++)nt(n[o],!1),yt(n[o]);else n!=null&&(nt(n,!1),yt(n));else nt(this,e)}const Us=e=>{var t,s,n,i;e.type==gt.CHILD&&((t=(n=e)._$AP)!==null&&t!==void 0||(n._$AP=Hs),(s=(i=e)._$AQ)!==null&&s!==void 0||(i._$AQ=zs))};class Ie extends Xt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,n){super._$AT(t,s,n),Me(this),this.isConnected=t._$AU}_$AO(t,s=!0){var n,i;t!==this.isConnected&&(this.isConnected=t,t?(n=this.reconnected)===null||n===void 0||n.call(this):(i=this.disconnected)===null||i===void 0||i.call(this)),s&&(nt(this,t),yt(this))}setValue(t){if(Ws(this._$Ct))this._$Ct._$AI(t,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=t,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}var G,lt,z,O,Wt,Kt,Oe,Pe;class qs extends Ie{constructor(s){super(s);b(this,O);b(this,G,null);b(this,lt,!1);b(this,z,null);D(this,lt,s.type===gt.ATTRIBUTE||s.type===gt.BOOLEAN_ATTRIBUTE)}render(s){return s!==v(this,G)&&(this.disconnected(),D(this,G,s),this.isConnected&&h(this,O,Wt).call(this)),v(this,G)?h(this,O,Kt).call(this,ye(v(this,G))):E}reconnected(){h(this,O,Wt).call(this)}disconnected(){var s;(s=v(this,z))==null||s.call(this),D(this,z,null)}}G=new WeakMap,lt=new WeakMap,z=new WeakMap,O=new WeakSet,Wt=function(){v(this,G)&&D(this,z,_(h(this,O,Pe).bind(this)))},Kt=function(s){return v(this,lt)?Zt(s):s},Oe=function(s){this.setValue(h(this,O,Kt).call(this,s))},Pe=function(){var s;h(this,O,Oe).call(this,(s=v(this,G))==null?void 0:s.call(this))};function a(e){return wt(qs)(x(e))}var H,rt,St,ut,Qt;class _e{constructor(t,s){b(this,ut);b(this,H);b(this,rt);P(this,"elements",new Set);b(this,St,ge(h(this,ut,Qt).bind(this)));D(this,H,t),D(this,rt,s)}connect(){h(this,ut,Qt).call(this);const t=new MutationObserver(v(this,St));for(const s of v(this,H))t.observe(s,{childList:!0,subtree:!0});at(()=>t.disconnect()),at(this.disconnect.bind(this))}disconnect(){this.elements.clear()}assign(t,s){bs(t)?(s.textContent="",s.append(t)):(ve(null,s),ve(t,s)),s.style.display||(s.style.display="contents");const n=s.firstElementChild;if(!n)return;const i=s.getAttribute("data-class");i&&n.classList.add(...i.split(" "))}}H=new WeakMap,rt=new WeakMap,St=new WeakMap,ut=new WeakSet,Qt=function(t){if(t&&!t.some(i=>i.addedNodes.length))return;let s=!1,n=v(this,H).flatMap(i=>[...i.querySelectorAll("slot")]);for(const i of n)!i.hasAttribute("name")||this.elements.has(i)||(this.elements.add(i),s=!0);s&&v(this,rt).call(this,this.elements)};let js=0,ht="data-slot-id";var U,Tt,q,$t;class Ge{constructor(t){b(this,q);b(this,U);P(this,"slots");b(this,Tt,ge(h(this,q,$t).bind(this)));D(this,U,t),this.slots=new _e(t,h(this,q,$t).bind(this))}connect(){this.slots.connect(),h(this,q,$t).call(this);const t=new MutationObserver(v(this,Tt));for(const s of v(this,U))t.observe(s,{childList:!0});at(()=>t.disconnect())}}U=new WeakMap,Tt=new WeakMap,q=new WeakSet,$t=function(){for(const t of v(this,U))for(const s of t.children){if(s.nodeType!==1)continue;const n=s.getAttribute("slot");if(!n)continue;s.style.display="none";let i=s.getAttribute(ht);i||s.setAttribute(ht,i=++js+"");for(const o of this.slots.elements){if(o.getAttribute("name")!==n||o.getAttribute(ht)===i)continue;const r=document.importNode(s,!0);n.includes("-icon")&&r.classList.add("vds-icon"),r.style.display="",r.removeAttribute("slot"),this.slots.assign(r,o),o.setAttribute(ht,i)}}};function Ys({name:e,class:t,state:s,paths:n,viewBox:i="0 0 32 32"}){return l`<svg
  ...
  `}function ze(){const{audioGains:e}=u(),t=e();return V(t)?t[0]??0:t.min}function He(){const{audioGains:e}=u(),t=e();return V(t)?t[t.length-1]??300:t.max}function Gn(){const{audioGains:e}=u(),t=e();return V(t)?t[1]-t[0]||25:t.step}function Ln(){return a(()=>{const{translations:e}=u(),{hasCaptions:t}=g(),s=d(e,"Off");return t()?l`
  ...
  `}function Hn(){return a(()=>{const{live:e,duration:t}=g();return e()?Ee():t()?l`<media-time class="vds-time" type="current" toggle remainder></media-time>`:null})}function Ye(){return a(()=>{const{live:e}=g();return e()?Ee():zn()})}function Ze(){return a(()=>{const{textTracks:e}=C(),{title:t,started:s}=g(),n=w(null);return we(e,"chapters",n.set),n()&&(s()||!t())?Xe():l`<media-title class="vds-chapter-title"></media-title>`})}function Xe(){return l`<media-chapter-title class="vds-chapter-title"></media-chapter-title>`}class Je extends Xs{async loadIcons(){const t=(await Ts(async()=>{const{icons:n}=await import("./vidstack-H72EDyqs-Cj445G1A.js");return{icons:n}},__vite__mapDeps([0,1]))).icons,s={};for(const n of Object.keys(t))s[n]=Ys({name:n,paths:t[n]});return s}}var F;let Un=(F=class extends Ct{},P(F,"props",{...Lt(F,F,"props"),when:({viewType:t})=>t==="audio",smallWhen:({width:t})=>t<576}),F);function qn(){return[Jt(),ne(),l`
    ...
    `]}function jn(){return a(()=>{let e=w(void 0),t=w(!1),s=C(),{title:n,started:i,currentTime:o,ended:r}=g(),{translations:p}=u(),c=Ls(e),y=()=>i()||o()>0;const f=()=>{const S=r()?"Replay":y()?"Continue":"Play";return`${k(p,S)}: ${n()}`};_(()=>{var S;c()&&document.activeElement===document.body&&((S=s.player.el)==null||S.focus({preventScroll:!0}))});function m(){const S=e(),T=!!S&&!c()&&S.clientWidth<S.children[0].clientWidth;S&&Ns(S,"vds-marquee",T),t.set(T)}function $(){return l`
      ...
      `}return ke(e,m),n()?l`
        ...
        `:L()})}function Yn(){const e="top end";return[Qe({tooltip:"top",placement:e,portal:!0}),je({tooltip:"top end",placement:e,portal:!0})]}var mt,Z,A,ts,es,ss,ns,is,as;class Ut extends Ce(De,Un){constructor(){super(...arguments);b(this,A);b(this,mt);b(this,Z,w(!1))}onSetup(){this.forwardKeepAlive=!1,D(this,mt,C()),this.classList.add("vds-audio-layout"),h(this,A,ss).call(this)}onConnect(){Fe("audio",()=>this.isMatch),h(this,A,es).call(this)}render(){return a(h(this,A,ts).bind(this))}}mt=new WeakMap,Z=new WeakMap,A=new WeakSet,ts=function(){return this.isMatch?qn():null},es=function(){const{menuPortal:s}=u();_(()=>{if(!this.isMatch)return;const n=Ke(this,this.menuContainer,"vds-audio-layout",()=>this.isSmallLayout),i=n?[this,n]:[this];return(this.$props.customIcons()?new Ge(i):new Je(i)).connect(),s.set(n),()=>{n.remove(),s.set(null)}})},ss=function(){const{pointer:s}=v(this,mt).$state;_(()=>{s()==="coarse"&&_(h(this,A,ns).bind(this))})},ns=function(){if(!v(this,Z).call(this)){Nt(this,"pointerdown",h(this,A,is).bind(this),{capture:!0});return}Nt(this,"pointerdown",s=>s.stopPropagation()),Nt(window,"pointerdown",h(this,A,as).bind(this))},is=function(s){const{target:n}=s;Gs(n)&&n.closest(".vds-time-slider")&&(s.stopImmediatePropagation(),this.setAttribute("data-scrubbing",""),v(this,Z).set(!0))},as=function(){v(this,Z).set(!1),this.removeAttribute("data-scrubbing")},P(Ut,"tagName","media-audio-layout"),P(Ut,"attrs",{smallWhen:{converter(s){return s!=="never"&&!!s}}});/**
 * @license
